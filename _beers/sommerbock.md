...
style: Helles Bock
group: Bock
logo: /assets/images/beer/sommerbock.png
description:
    "Another light lager for the summer months that will utilize a harvested lager strain that fermented Helles Bock and
    Doppelbock V2. While German Pils is fermenting I want to get another beer started to keep up with the summer. This
    should be a crisp, light lager that is easy drinking but still flavorful."
malts:
...
tasting_notes:
    - title: "Original 2021 Version"
      description:
          ...
          1.052) resulted in 6.4% ABV instead of target 5.3%. A crisp, light lager for summer drinking."
---
