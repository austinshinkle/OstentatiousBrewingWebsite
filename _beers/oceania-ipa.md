---
layout: beer
beer_key: oceania-ipa
title: "Oceania IPA"
status: past_beer
style: Southern Hemisphere IPA
group: India Pale Ale
logo: /assets/images/beer/oceania_ipa.png
description:
    "This IPA uses all Australian and New Zealand hops bought from Yakima Valley Hops. It will have a light backbone to
    showcase the southern hemisphere hops which tend to be more juicy and fruit forward."
malts:
...
brewing_instructions:
    ...
    - Total wort volume should be 7.36 gallons
    ...
    - At 0 minutes, add 0.3 oz Galaxy hops
    - At 0 minutes, add 0.3 oz Ella hops
    - At 50 minutes, add one tablet Whirlfloc
    - At 50 minutes, add 1/2 tsp of yeast nutrient
    - At 55 minutes, add 1 oz Dr. Rudi hops
    - At 55 minutes, add 1 oz Enigma hops
    - At 55 minutes, add 1 oz Rakau hops
...
starter_instructions:
    - None (Yeast cake from Yakima IPA)
...
tasting_notes:
    - title: "Southern Hemisphere Showcase"
      description:
          ...
          fruit-forward hop character typical of southern hemisphere varieties."
---
