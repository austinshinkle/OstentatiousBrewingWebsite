...
description:
    "The first beer after taking a break for 3 years! Belgian beers are typically forgiving, taste excellent and are
    ales, which means it will be ready earlier. It should be a light bodied, golden ale with a typical Belgian profile.
    Start small. Prost!"
malts:
...
brewing_instructions:
    ...
    - At 40 minutes, add 1.0 oz Hallertauer Mittelfrüh hops
...
brewers_notes:
    - title: "Return to Brewing After 3 Years"
      description:
          ...
          the mash temperature. If you make this again, mash at a lower temperature to get a drier finish. Also, maybe
          try a hop with a little more fruity character that can be accentuated by the yeast."
---
